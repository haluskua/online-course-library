...
var resetButton = document.querySelector(".clear-all"); //Event Listeners

document.addEventListener('DOMContentLoaded', getTodos);
todoButton.addEventListener('click', addTodo);
todoList.addEventListener('click', deleteCheck);
filterOption.addEventListener('click', filterTodo);
resetButton.addEventListener('click', resetData); //Functions
//function: resetData
...
function addTodo(event) {
  event.preventDefault(); //Prevent form from submittig
  //  console.log('hello');
  //tod DIV
  ...
  todoDiv.appendChild(newTodo); //ADDTODO TO LOCALSTORAGE
...
function deleteCheck(e) {
  ...
  if (item.classList[0] === "trash-btn") {
    var todo = item.parentElement; //asNIMATION
