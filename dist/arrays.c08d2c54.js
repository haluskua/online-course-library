...
Enemy.prototype.attack = function () {
  console.log("".concat(this.name, " has attacked!"));
};

Enemy.prototype.block = function () {
  console.log("".concat(this.name, " has blocked"));
...
function Dragon(life, name, level, color, spell) {
  ...
  Enemy.call(this, life, name, level); //Define it as normal for the other arguements
...
var newDragon = new Dragon(100, "Dragon", 25, "green", "fire");
console.log(newDragon); //////////////////////////////////////////////////////////////////////////////////////
// CLASSES

var Worrior = /*#__PURE__*/function () {
  function Worrior(life, name, level) {
    _classCallCheck(this, Worrior);
...
var turtle = new Worrior(this.life, this.name, this.level);
var bug = new Worrior(25, 'Squidlebug', 10);
turtle.getInfo();
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/arrays.js"], null)
